...
if BUSES["NES_CTRL"] then
	files {
		...
		MAME_DIR .. "src/devices/bus/nes_ctrl/oekakids.cpp",
		MAME_DIR .. "src/devices/bus/nes_ctrl/oekakids.h",
		...
		MAME_DIR .. "src/devices/bus/nes_ctrl/racermate_ctrl.cpp",
		MAME_DIR .. "src/devices/bus/nes_ctrl/racermate_ctrl.h",
